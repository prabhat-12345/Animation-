...
# Standard Raw HTML Injection (Error Free Strings)
romantic_card_html = """<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @keyframes pulseGlow {
            ...
            50% { opacity: 1; transform: scale(1); text-shadow: 0 0 15px #ff0055; }
...
<script>
    ...
    function loop() {
        ...
        ctx.lineCap = 'round';
        ctx.beginPath();
        ctx.moveTo(anchor.x - 50, anchor.y - 20);
        ctx.lineTo(anchor.x - 50, anchor.y + 15);
        ctx.lineTo(anchor.x, anchor.y + 50);
        ctx.lineTo(anchor.x, anchor.y + 110);
        ctx.moveTo(anchor.x + 50, anchor.y - 20);
        ctx.lineTo(anchor.x + 50, anchor.y + 15);
